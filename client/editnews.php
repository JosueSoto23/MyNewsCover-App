...
<nav class="navbar navbar-default">
                ...
                <form class="navbar-form navbar-right">
                    <div class="dropdown">
                        ...
                        <a class="dropdown-item" href="logica/cerrarSesion.php">Logout</a>
                            <br>    
                            <a class="dropdown-item" href="crud.php">News Source</a>
                        </div>
                    </div>
                </form>
            </div><!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <h1>News Source</h1>
        <form action="logica/log2.php?id=<?php echo $array['id'] ?>" method="POST" class="form-group row" role="form">
            <div class="col-xs-6">
                <hr>
            </div>
            <br><br><br>
            <div class="col-xs-3">
                <input type="text" class="form-control" id="" name="name" placeholder="Name" value="<?php echo $array['nameN'];?>">
            </div>
            <br><br><br>
            <div class="col-xs-6">
                <label class="sr-only" for="">RSS URL</label>
                <input type="text" class="form-control" id="" name="url" placeholder="RSS URL" value="<?php echo $array['urls'];?>">
            </div>
            <br><br><br>
            <div class="col-xs-3">
